namespace ModelExport
{
	partial class SettingsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.BtnPathTexpages = new System.Windows.Forms.Button();
			this.TxPathTexpages = new System.Windows.Forms.TextBox();
			this.labelTexpages = new System.Windows.Forms.Label();
			...
			// BtnPathTexpages
			// 
			this.BtnPathTexpages.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.BtnPathTexpages.Location = new System.Drawing.Point(566, 64);
			this.BtnPathTexpages.Name = "BtnPathTexpages";
			this.BtnPathTexpages.Size = new System.Drawing.Size(52, 20);
			this.BtnPathTexpages.TabIndex = 8;
			this.BtnPathTexpages.Text = "Browse";
			this.BtnPathTexpages.UseVisualStyleBackColor = true;
			this.BtnPathTexpages.Click += new System.EventHandler(this.BtnPathTexpages_Click);
			// 
			// TxPathTexpages
			// 
			this.TxPathTexpages.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.TxPathTexpages.Location = new System.Drawing.Point(99, 64);
			this.TxPathTexpages.Name = "TxPathTexpages";
			this.TxPathTexpages.Size = new System.Drawing.Size(461, 20);
			this.TxPathTexpages.TabIndex = 7;
			// 
			// labelTexpages
			// 
			this.labelTexpages.AutoSize = true;
			this.labelTexpages.Location = new System.Drawing.Point(12, 67);
			this.labelTexpages.Name = "labelTexpages";
			this.labelTexpages.Size = new System.Drawing.Size(69, 13);
			this.labelTexpages.TabIndex = 6;
			this.labelTexpages.Text = "Textures dir";
			// 
			// BtnPathTemp
			// 
			...
			this.BtnPathTemp.Location = new System.Drawing.Point(566, 90);
			this.BtnPathTemp.Name = "BtnPathTemp";
			this.BtnPathTemp.Size = new System.Drawing.Size(52, 20);
			this.BtnPathTemp.TabIndex = 11;
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.TxPathTemp.Location = new System.Drawing.Point(99, 90);
			this.TxPathTemp.Name = "TxPathTemp";
			this.TxPathTemp.Size = new System.Drawing.Size(461, 20);
			this.TxPathTemp.TabIndex = 10;
			// 
			// label3
			// 
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.TxNote.Location = new System.Drawing.Point(15, 122);
			this.TxNote.Multiline = true;
			this.TxNote.Name = "TxNote";
			this.TxNote.ReadOnly = true;
			this.TxNote.Size = new System.Drawing.Size(603, 53);
			this.TxNote.TabIndex = 12;
			this.TxNote.Text = "Warzone 2100 models (.pie) and textures (.png) will be rendered together in the embedded 3D viewer.\r\nSubdirectories within the PIE folder will be scanned automatically.";
			// 
			// BtnCancel
			// 
			this.BtnCancel.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.BtnCancel.DialogResult = System.Windows.Forms.DialogResult.Cancel;
			this.BtnCancel.Location = new System.Drawing.Point(543, 185);
			...
			this.BtnSave.Location = new System.Drawing.Point(452, 185);
			...
			this.Controls.Add(this.BtnPathTexpages);
			this.Controls.Add(this.TxPathTexpages);
			this.Controls.Add(this.labelTexpages);
			...
			this.MinimumSize = new System.Drawing.Size(536, 250);
		...
		private System.Windows.Forms.Button BtnPathTexpages;
		private System.Windows.Forms.TextBox TxPathTexpages;
		private System.Windows.Forms.Label labelTexpages;
